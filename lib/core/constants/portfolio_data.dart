...
class PortfolioData {
  ...
  static const List<ProjectModel> projects = [
    ...
    ProjectModel(
      ...
      titleEn: "Neuss Time Tracker Pro - Enterprise Work & Leave Suite",
      titleAr: "تطبيق تايم تراكر (Neuss Time Tracker Pro) - إدارة ساعات العمل والإجازات",
      subtitleEn:
      ...
      featuresEn: [
        ...
        "Comprehensive Leave & Vacation management module: submit multi-day or hourly requests with live quota deductions",
        "Offline-resilient storage service (GetStorage & SharedPreferences) preventing data loss during network hiccups",
        "Role-secured enterprise REST API integration with token renewal and auto-login authentication",
        "Clean dark-mode corporate UI styled with custom typography, smooth fade transitions, and animated counters",
      ],
      featuresAr: [
        "عداد زمني دقيق لجلسات العمل المباشرة (StopWatchTimer) مع شارات الحضور المكتبي والتحكم ببدء وإنهاء الجلسة",
        "شريط تقويم زمني أفقي تفاعلي (EasyDateTimeline) لاستعراض سجلات الورديات وساعات العمل اليومية بدقة",
        "نظام إدارة الإجازات والمغادرات: تقديم طلبات الإجازة السنوية أو الساعية مع خصم الرصيد تلقائياً من الإجمالي (24 يوم)",
        "تخزين محلي آمن في وضع عدم الاتصال (GetStorage و SharedPreferences) يضمن حفظ السجلات حتى في انقطاع الشبكة",
        "ربط برمجي مع الـ REST API المؤسسي مع تجديد الـ Tokens وتسجيل الدخول التلقائي الآمن",
        "واجهة مستخدم داكنة راقية بـ Dark Mode مع خطوط احترافية وتأثيرات انتقال سلسة وعدادات رقمية متحركة",
      ],
      techStack: [
        "Flutter & Dart",
        "GetX State Management",
        "App Store Production Release",
        "StopWatchTimer Service",
        "EasyDateTimeline Calendar",
        "Dio & RESTful Client",
      ...
      galleryImages: [
        ...
        "assets/projects/time_tracker_1.png",
        "assets/projects/time_tracker_2.png",
        "assets/projects/time_tracker_3.png",
        "assets/projects/time_tracker_4.png",
        "assets/projects/time_tracker_5.png",
      ],
      githubUrl: "https://github.com/omarragab2020",
      architectureEn:
    ...
    ProjectModel(
      ...
      featuresEn: [
        ...
        "Instant Quranic Full-Text Search Engine with fast indexing, Surah mapping, and keyword highlight markers",
        "Comprehensive offline 40 Nawawiyya Hadith collection with in-depth commentaries, benefits, and search",
        "Smart Digital Sebha featuring circular target presets (33, 100, Open), sound effects, and haptic vibration feedback",
        "Astronomy-grade GPS prayer times calculator with dynamic next-prayer countdowns and background Athan alarm scheduler",
        "Interactive Qiblah compass with gyroscope/magnetometer orientation and OpenStreetMap integration",
        "Khatmah progress manager with milestone goal calculators and celebration dialogs",
      ],
      featuresAr: [
        "مصحف التجويد الملون بخطوط الرسم العثماني مع حفظ العلامات المرجعية والتفاسير المتعددة وقائمة تفاعلية للآيات",
        "مشغل صوتي متقدم للتلاوات يعمل في الخلفية ومن شاشة القفل مع التخزين المؤقت للاستماع بدون إنترنت",
        "محرك بحث قرآني فوري وسريع مع إبراز وتلوين الكلمات المطابقة ومواقع الآيات في السور",
        "موسوعة الأربعين النووية كاملة مع الشرح والفوائد بدون الحاجة للاتصال بالإنترنت مع البحث في الأحاديث",
        "سبحة إلكترونية ذكية بأهداف محددة (33، 100، مفتوح) مع مؤثرات صوتية وتغذية اهتزازية تفاعلية (Haptics)",
        "حاسبة مواقيت الصلاة الفلكية بدقة GPS مع عداد تنازلي للصلاة القادمة ومنبه أذان دائم في الخلفية",
        "بوصلة القبلة الدقيقة المعتمدة على حساسات الجيروسكوب وخرائط OpenStreetMap",
        "نظام متابعة الختمات القرآنية (Khatmah Manager) لتحديد الأهداف اليومية واحتفاليات إتمام الختمة",
      ],
      techStack: [
        "Flutter & Dart",
        ...
        "AndroidAlarmManager & AwesomeNotifications",
        "QuranLibrary & Custom Fonts",
        "Vibration & Haptics",
        "FlutterMap & OSM",
        "Clean Architecture",
      ],
      ...
      galleryImages: [
        ...
        "assets/projects/quran_screen_1.png",
        "assets/projects/quran_screen_2.png",
        "assets/projects/quran_screen_3.png",
        "assets/projects/quran_screen_4.png",
        "assets/projects/quran_screen_5.png",
      ],
      githubUrl: "https://github.com/omarragab2020",
      architectureEn:
